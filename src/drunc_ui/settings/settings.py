...
# SECURITY WARNING: this must be set correctly in production.
...
# Custom settings
INSTALLED_APPS += [
    "drunc_ui.main.apps.MainConfig",
    "drunc_ui.controller.apps.ControllerConfig",
    "drunc_ui.process_manager.apps.ProcessManagerConfig",
    "drunc_ui.session_manager.apps.SessionManagerConfig",
]
...
INSTALLED_APPS += ["django_tables2", "django_bootstrap5"]
