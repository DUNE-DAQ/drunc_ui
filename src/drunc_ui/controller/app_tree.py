...
from drunc_ui.interfaces.controller_interface import get_controller_status, get_detectors
from drunc_ui.interfaces.process_manager_interface import get_hostnames
