...
from drunc_ui.session_manager.tables import ActiveSessions, AvailableConfigs
...
class TestActiveSessionsView(LoginRequiredTest):
    ...
    def test_sessions_table(self, auth_client, mocker):
        ...
        mock = mocker.patch("drunc_ui.interfaces.session_manager_interface.get_sessions")
...
class TestAvailableConfigsView(LoginRequiredTest):
    ...
    def test_available_configs(self, auth_client, mocker):
        """Tests basic calls of view method."""
        mock = mocker.patch("drunc_ui.interfaces.session_manager_interface.get_configs")
